...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DW3000_CHIP_DW3000, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DW3000_SPI_MAX_MHZ, 32);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DW3000_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DW3000_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_DECADRIVER_MODULE, 1);
